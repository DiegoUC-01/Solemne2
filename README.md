...
## Ejecución con Docker Compose (producción)(Método Recomendado)

```bash
# Descargar archivo de orquestación
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/DiegoUC-01/Solemne2/main/docker-compose.prod.yml" -OutFile docker-compose.prod.yml

# Levantar el frontend (backend y MongoDB están en la nube), tener docker desktop abierto
docker compose -f docker-compose.prod.yml up -d
```

Esto levanta:
- **Frontend** en `localhost:5173` (imagen desde DockerHub)
- **Backend** en Render: `solemne2.onrender.com`
...
- **Backend (Render):** [solemne2.onrender.com](https://solemne2.onrender.com/)
- **DockerHub Frontend:** [diegoalvarez1/15dias-frontend](https://hub.docker.com/r/diegoalvarez1/15dias-frontend)
- **DockerHub Backend:** [diegoalvarez1/15dias-backend](https://hub.docker.com/r/diegoalvarez1/15dias-backend)
